...
def test_invalid_interface_exits(runner: CliRunner):
...
def test_external_ip_uses_gateway(runner: CliRunner, interface: str, external_ip: str):
    result = runner.invoke(main, [interface, "-i", external_ip])
